...
namespace BlogAPI.Controllers
{
    ...
    public class RolesController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromForm] CreateRoleModel newRole)
        {
        ...
        [HttpPost]
        [Route("EditRole/{id}")]
        public async Task<IActionResult> EditRole([FromRoute] string id, [FromForm] EditeRoleModel newRole)
        {
            Role role = await _roleManager.FindByIdAsync(id);
            if (role != null)
            {
